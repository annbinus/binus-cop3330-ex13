...
public class DeterminingCI {
    public static void main(String[] args) {
        ...
        double compoundInterest = principal*(Math.pow((1 + rate/(100*n)), n*year));

        System.out.println("$" + principal + " invested at " + rate + "% for " + year + " years compounded " + n + " times per year is $" + (double)Math.round(compoundInterest*100)/100 + ".");
    }
}
